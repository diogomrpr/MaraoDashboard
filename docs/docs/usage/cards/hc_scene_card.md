...
```yaml
  - type: custom:button-card
    ...
    variables:
      icon_1: marao_dashboard:house-fill
      name_1: Home
      scene_1: scene.home
      icon_2: marao_dashboard:computer
      name_2: Work
      scene_2: scene.work
      icon_3: marao_dashboard:door-open
      name_3: Away
      scene_3: scene.away
      icon_4: marao_dashboard:moon-stars
      name_4: Night
      scene_4: scene.night      
      icon_5: marao_dashboard:clapper-open
      name_5: Movie
      scene_5: scene.movie
```
