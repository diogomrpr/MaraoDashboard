...
| <span class="entry-type-marao_dashboard"></span> enable_slider | False | No | Show or hide the brightness slider|
| <span class="entry-type-marao_dashboard"></span> card_color | var(--color-orange) | No | The color of the card |
