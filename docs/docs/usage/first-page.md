...
Now, the most exciting part begins. Creating your first page. Actually we're going to edit your first page since you had to create a page while installing Marao Dashboard. There are 2 ways to go. 

You can create multiple views for different types like lights, security, switches or livingroom, bathroom and bedroom OR you can put everything on one page. Either way, Marao Dashboard will work just fine so its totally up to you.
...
2. **Open your view file**
    ...
    title: Home
    path: "home"
    icon: marao_dashboard:house-fill
    cards:
        - type: vertical-stack
          cards:
